                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="project-card bg-white shadow-lg rounded-lg p-4">
                            ...
                            <p className="text-gray-700 mb-4">I developed a web application for **managing lawyer appointments**, built with <strong>**Symfony**</strong> for robust backend logic and **Bootstrap** for a responsive, intuitive user interface. This platform streamlines the booking process, allowing clients to easily schedule consultations while providing lawyers with an efficient system to manage their availability and appointments.</p>
                            <div className="logo h-25 w-25 mb-4 rounded-lg flex items-center justify-center hover:animate-spin">
                                <img src={symfony} alt="" />
                            </div>
                        ...
                        <div className="project-card bg-white shadow-lg rounded-lg p-4 ">
                            ...
                            <p className="text-gray-700 mb-4">A portfolio is a personal online showcase, a dynamic collection of your best work, projects, and achievements. It's designed to highlight your skills and expertise to potential employers or clients. This specific portfolio was crafted with <strong>**React**</strong>, leveraging its component-based architecture for a highly interactive and responsive user experience.</p>
                            <div className="logo h-25 w-25 mb-4 rounded-lg flex items-center justify-center hover:animate-spin">
                                <img src={react} alt="" />
                            </div>
